...
public class DocumentFeaturesIndex extends EntityIndex {
	private String dbName = "docIdx";
	
	public DocumentFeaturesIndex() {
		this.init(this.dbName);
	}
	
	public DocumentFeaturesIndex(String dbName) {
		this.dbName = dbName;
		this.init(this.dbName);
	}
