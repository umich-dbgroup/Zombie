 ...
 *
 */
public class IsSettlementUDF implements UDF {
	public static final String ID_STRING = "is_settlement";
	String udfDesc;

	public static UDF createUDF(String udfDesc) {
		return new IsSettlementUDF(udfDesc);
	}

	public IsSettlementUDF(String udfDesc) {
