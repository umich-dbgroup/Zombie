 ...
 *
 */
public class IsDarkImageUDF implements UDF {
	public static final String ID_STRING = "is_dark_image";
	String udfDesc;

	public static UDF createUDF(String udfDesc) {
		return new IsDarkImageUDF(udfDesc);
	}

	public IsDarkImageUDF(String udfDesc) {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(IsDarkImageUDF.getBrightness(img));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
