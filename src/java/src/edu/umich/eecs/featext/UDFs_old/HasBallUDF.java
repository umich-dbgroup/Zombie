 ...
 *
 */
public class HasBallUDF implements UDF {
  public static final String ID_STRING = "ball";
  String udfDesc;
  
  public static UDF createUDF(String udfDesc) {
    return new HasBallUDF(udfDesc);
  }

  public HasBallUDF(String udfDesc) {
